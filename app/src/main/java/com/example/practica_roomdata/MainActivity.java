package com.example.practica_roomdata;

import android.content.Intent;
import android.os.Bundle;

import com.example.practica_roomdata.adaptador.AnimalListAdapter;
import com.example.practica_roomdata.roomdatabase.Animal;
import com.example.practica_roomdata.viewmodel.AnimalViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resulCode, Intent data){
        ...
        if(requestCode == NUEVO_ANIMAL_RC && resulCode == RESULT_OK){
